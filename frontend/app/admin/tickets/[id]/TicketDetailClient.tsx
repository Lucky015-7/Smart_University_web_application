...
export default function TicketDetailClient({
  ...
  useEffect(() => {
    ...
    if (initialTicket) {
      ...
      setNewStatus(initialTicket.status)
      setResolutionNotes(initialTicket.resolutionNotes || "")
    ...
    fetchTicket()
  }, [ticketId, initialTicket, initialComments, initialCurrentUserId])
